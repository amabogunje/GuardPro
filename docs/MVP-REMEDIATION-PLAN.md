...
**Current work:** X7/R-001 release-suite isolation remediation is ready for independent verification; owner evidence and subscription work remain ready for independent verification.
**Next issue:** G6: collect signed real-device evidence across guard, supervisor and owner journeys.
**Progress:** S0 is verified locally and remains Not released. S1–S7, G1–G5, G7 and O1–O8 remain ready for independent verification. G6 is blocked on real-device evidence across all roles; X7/R-001 are ready for independent verification following a clean full release suite.
...
| O3 | P1 | Ready for verification | Align patrol score/label with D5; disclose unknown/partial measurement and Any staffing limitations. No start-only evidence presented as completion. | Focused owner API/browser fixtures pass; owner/supervisor/export reconciliation remains independent-review work. |
