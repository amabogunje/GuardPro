...
function qualify(statement) {
  const tables =
    "customers|users|sites|assignments|checkpoints|sessions|events|shifts|incidents|revisions|transitions|media|notifications|summaries|audit|shift_plans|site_locations|instruction_versions|message_media|message_context|rate_limits|user_photos|shift_templates|disabled_users|retired_checkpoints|user_contacts|property_locations|location_reviews|incident_classifications";
